...
function buildProps(node, context, props = node.props, ssr = false) {
  ...
  const analyzePatchFlag = ({ key, value }) => {
    if (isStaticExp(key)) {
      ...
      if (!isComponent2 && isEventHandler && // omit the flag for click handlers because hydration gives click
      // dedicated fast path.
...
var VueWrapper = (
  ...
  function(_super) {
    ...
    function VueWrapper2(app, vm, setProps) {
      ...
      _this.componentVM = vm && // a component with a setup that returns a render function will have no `devtoolsRawSetupState`
      vm.$.devtoolsRawSetupState ? vm.$.proxy : vm;
